---
title: "Introducing ribofootprintR"
md_document:
...
To install the package after downloading the tarball please use the snippet
...
##Loading the Data
Before we get to do any analysis we need to load the data. Let's first start with the data.frame and FASTA file. 
